        ...
        if (!adf.mf.environment.profile.dtMode)
        {
          ...
          for (var i=0, length = tagInstances.length; i < length; i++)
          {
                  ...
                  ":closePopupBehavior")
            {
              ...
              {
                    popupActions.push(
                      { "type": "close", "node": amxNode, "tagInstance": tagInstance });
              }
            }
          }
          // Start of Phase 3.
                    ...
                    rootNode.visit(
                      ...
                      function (visitContext, amxNode)
                      {
                        ...
                        var expr = tagInstance.getAttribute("binding");
                                  actionListenerPromise = adf.mf.api.amx.invokeEl(expr, params,
                                    null, paramTypes);
                  ...
                  if (attrType === amxEventType)
                  {
                    ...
                    rootNode.visit(
                      ...
                      function (visitContext, amxNode)
                      {
                        ...
                        // calling function.
                                  closePopupPromise = amx.processClosePopupBehavior(amxNode,
                                    tagInstance);
                        return adf.mf.api.amx.VisitResult["COMPLETE"];
                      });

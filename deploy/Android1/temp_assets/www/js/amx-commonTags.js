...
(function()
{
    ...
    descendentChanges)
  {
    ...
    if (attributeChanges.hasChanged("source"))
    {
      ...
      var cl = domNode.classList;
      var errorClass = "amx-image-error";
      if (cl.contains(errorClass))
      {
        cl.remove(errorClass);
        // If the error class is present, the _handleError callback will have been removed,
    ...
    rootElement)
  {
    ...
    if (hasIcon)
    {
      ...
      {
        iconElem.setAttribute("src", adf.mf.api.amx.buildRelativePath(
          amxNode.getAttribute("icon")));
      }
    }
